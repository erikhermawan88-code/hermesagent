...
description: 54 real design systems (Stripe, Linear, Vercel, etc.) as HTML/CSS — source of truth for non-generic design references.
trigger: "MUST LOAD before every website project. This skill prevents generic/template-looking outputs by providing real premium design references. For additional UI/UX patterns, also load shadcn-ui-components and design-tokens skills."
version: 1.1.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [design, reference, css, html, web]
---
license: MIT
